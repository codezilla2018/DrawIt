...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction responseArrayBuffer(response) {\n  if (!response.ok) throw new Error(response.status + \" \" + response.statusText);\n  return response.arrayBuffer();\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (function(input, init) {\n  return fetch(input, init).then(responseArrayBuffer);\n});\n\n\n//# sourceURL=webpack://DI/./node_modules/d3-fetch/src/buffer.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (function(input, init) {\n  return new Promise(function(resolve, reject) {\n    var image = new Image;\n    for (var key in init) image[key] = init[key];\n    image.onerror = reject;\n    image.onload = function() { resolve(image); };\n    image.src = input;\n  });\n});\n\n\n//# sourceURL=webpack://DI/./node_modules/d3-fetch/src/image.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction responseJson(response) {\n  if (!response.ok) throw new Error(response.status + \" \" + response.statusText);\n  return response.json();\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (function(input, init) {\n  return fetch(input, init).then(responseJson);\n});\n\n\n//# sourceURL=webpack://DI/./node_modules/d3-fetch/src/json.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction responseText(response) {\n  if (!response.ok) throw new Error(response.status + \" \" + response.statusText);\n  return response.text();\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (function(input, init) {\n  return fetch(input, init).then(responseText);\n});\n\n\n//# sourceURL=webpack://DI/./node_modules/d3-fetch/src/text.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar conf = exports.conf = {\n  bindto: \"\",\n  data: {\n    x: \"\",\n    json: [],\n    type: \"\",\n    keys: {\n      value: []\n    }\n\n  },\n  axis: {\n    x: {\n      type: 'category'\n    }\n  }\n};\n\n//# sourceURL=webpack://DI/./src/config_templates/c3.config.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.generate = generate;\n\nvar _fileParser = __webpack_require__(/*! ./file-parser */ \"./src/file-parser.js\");\n\nvar _c3Config = __webpack_require__(/*! ./config_templates/c3.config.js */ \"./src/config_templates/c3.config.js\");\n\nfunction generate(url, selector, callback) {\n    var chart_type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';\n    var axises = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};\n    var additional_configs = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : {};\n\n    (0, _fileParser.getDataFromFile)(url).then(function (resp) {\n        modifyConfigs(selector, resp, chart_type, [axises.x, axises.y], additional_configs);\n        console.log(_c3Config.conf);\n        callback(_c3Config.conf);\n    }, errHandle);\n}\n\nvar errHandle = function errHandle(err) {\n    return err;\n};\n\nfunction modifyConfigs() {\n    var bindto = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';\n    var arr = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];\n    var chart_type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'line';\n    var keys = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];\n    var more = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};\n\n    delete arr.columns;\n    _c3Config.conf.data.json = arr;\n    _c3Config.conf.data.x = keys[0];\n    _c3Config.conf.data.keys.value = keys;\n    _c3Config.conf.bindto = '#' + bindto;\n    _c3Config.conf.data.type = chart_type;\n}\n\n//# sourceURL=webpack://DI/./src/index.js?");
